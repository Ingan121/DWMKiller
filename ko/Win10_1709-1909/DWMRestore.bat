...
<nul set /p =Winlogon 복구 중...
pssuspend winlogon.exe -r -nobanner>nul
...
move C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe.bak C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe>nul
if not errorlevel 1 (echo   SearchUI.exe: 성공) else echo   SearchUI.exe: 실패

move C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe.bak C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe>nul
