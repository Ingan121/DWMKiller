...
taskkill -im WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe -f>nul 2>nul
if not errorlevel 1 (echo   WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe: 종료됨) else echo   WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe: 실행 중이 아님
...
taskkill -im SearchUI.exe -f>nul 2>nul
if not errorlevel 1 (echo   SearchUI.exe: 종료됨) else echo   SearchUI.exe: 실행 중이 아님
...
takeown /a /f C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe>nul
icacls C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe /grant Administrators:F>nul
move C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe C:\Windows\SystemApps\Microsoft.Windows.Cortana_cw5n1h2txyewy\SearchUI.exe.bak>nul
if not errorlevel 1 (echo   SearchUI.exe: 성공) else echo   SearchUI.exe: 실패

takeown /a /f C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe>nul
icacls C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe /grant Administrators:F>nul
move C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe C:\Windows\SystemApps\InputApp_cw5n1h2txyewy\WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe.bak>nul
if not errorlevel 1 (echo   WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe: 성공) else echo   WindowsInternal.ComposableShell.Experiences.TextInput.InputApp.exe: 실패
